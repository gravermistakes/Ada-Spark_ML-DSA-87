...
procedure Test_Verify_Adv87 is
...
begin
   ...
   New_Line;
   if Fails = 0 then
      Put_Line ("VERIFY-ADV-87 GATE PASSED: accepts valid, rejects 1-bit tamper");
   else
      Put_Line ("VERIFY-ADV-87 FAILURES:" & Fails'Image);
      Ada.Command_Line.Set_Exit_Status (Ada.Command_Line.Failure);
   end if;
end Test_Verify_Adv87;
