...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_test_ntt" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#1fc20ab0#;
   pragma Export (C, u00001, "test_nttB");
   ...
   u00133 : constant Version_32 := 16#44d96c1e#;
   pragma Export (C, u00133, "lthing_mldsa_fieldB");
   u00134 : constant Version_32 := 16#f60020ab#;
   pragma Export (C, u00134, "lthing_mldsa_fieldS");
   ...
   u00139 : constant Version_32 := 16#d5171271#;
   pragma Export (C, u00139, "lthing_mldsa_nttB");
   u00140 : constant Version_32 := 16#af7b8cd1#;
   pragma Export (C, u00140, "lthing_mldsa_nttS");
   u00141 : constant Version_32 := 16#ca878138#;
   pragma Export (C, u00141, "system__concat_2B");
   u00142 : constant Version_32 := 16#f796dc4f#;
   pragma Export (C, u00142, "system__concat_2S");
   u00143 : constant Version_32 := 16#d22fc2e4#;
   pragma Export (C, u00143, "system__memoryB");
   u00144 : constant Version_32 := 16#19e99d68#;
   ...
   --  system.assertions%s
   --  system.assertions%b
   --  lthing_mldsa_field%s
   --  lthing_mldsa_field%b
   --  lthing_mldsa_ntt%s
   --  lthing_mldsa_ntt%b
   --  test_ntt%b
